...
import sys
# sys.path.append(r'C:\Users\VSviderskij\Perforce\tools\depot\users\vsviderskij\scripts\modules')
# import funcs
file = r"C:\Users\VSviders\Documents\tools\Signal_Analysis_Tool\pdm\PDM Capture\THD_1p536MHz_6649hzInject_PDM_062821.txt"
file = r"C:\Users\VSviders\Documents\tools\Signal_Analysis_Tool\pdm\Datalog and DataPDM\Noise_2p4MHz_111721_PDM.txt"
lala = PDM_ANALYSIS(file, signal_params_2400)
#%%
...
import os
signal_params = {
    'file': r"C:\Users\VSviderskij\Desktop\DEVs\PROJECTS\Miltonduff\test program\06_05_2022\IDAC_TRIM_Datalog_PDM\PDM\IDAC_Initial_PDM_562022.txt",
    'Fclk': 2.4e+6,
    'zero_one_convert':True,
    'bw_low': 20,
    'bw_high': 20e+3,
...
lala = os.path.join(os.path.dirname(__file__), 'temp.json')

with open(lala, 'w') as f:
    json.dump(signal_params_768, f)
...
foo = Config(signal_params_768)
print(foo.config['Fclk'])
#%%
os.remove(lala)
...
step = 1e-2
res = 10
thd_arr = lala.signal_sweep(signal='noise',freq_bin_res=res, step=step, plot=True)
...
files = funcs.list_files(r'C:\Users\VSviderskij\Desktop\DEVs\PROJECTS\Miltonduff\sens')


for file in files:
    lala = PDM_ANALYSIS(file, signal_params_3072)
    tone = lala.calculate_THD(plot=True)
...
import time
import numpy as np
path = r"C:\Users\VSviderskij\Desktop\DEVs\PROJECTS\Ardbeg\DataPDM_10s\DataPDM_10s\THD_115_3p84MHz_111821_PDM_10s.txt"
st = time.time()
#inp = np.loadtxt(path, dtype=int)
